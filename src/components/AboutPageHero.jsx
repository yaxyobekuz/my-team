  ...
  return (
    <div className="py-120 relative max-730:py-28 max-370:pt-84 max-370:pb-28">
      ...
      <img
        width={100}
        height={200}
        className="absolute bottom-0 right-0 h-200 bg-cover object-left object-cover z-0 max-1200:-bottom-100 max-730:bottom-0 max-640:-bottom-100"
        src={circleShape}
