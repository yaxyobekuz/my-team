    ...
    <div className="py-120 relative max-730:py-28 max-370:py-84">
      <div className="grid container grid-cols-2 gap-30px max-730:grid-cols-1 max-730:gap-16 max-370:gap-56px">
        <div className="flex flex-col max-730:items-center max-730:max-w-515 max-730:mx-auto">
          <h1 className="text-64 mb-4 max-730:mb-6 max-370:mb-4 small-h1">
            Contact
          </h1>

          <p className="leading-48 text-32 text-primary-light_coral mb-8 max-730:mb-6 max-370:mb-10">
            Ask us about
          </p>
        ...
        <form
          ...
          className="flex flex-col max-730:max-w-540 max-730:mx-auto max-730:w-full"
        >
          <input
            required
            type="text"
            ...
            placeholder="Name"
            autoComplete="off"
            className="light-input_sytles pt-0"
          />
          ...
          <input
            ...
            placeholder="Email"
            autoComplete="off"
            className="light-input_sytles email-input"
          />

          <span className="warning italic text-10 font-bold leading-normal ml-3 text-primary-light_coral mt-2">
          ...
          <input
            ...
            name="company name"
            autoComplete="off"
            className="light-input_sytles company-name-input"
            required
          />
          <input
            type="text"
            ...
            name="title"
            autoComplete="off"
            className="light-input_sytles"
            required
          />
          <textarea
            name="message"
            className="light-input_sytles pb-14 mb-6 resize-none"
            placeholder="Message"
            required
          ></textarea>
          <button className="secondary-btn_light max-w-max text-secondary-deep_jungle_green">
            submit
          </button>
        </form>
      </div>
